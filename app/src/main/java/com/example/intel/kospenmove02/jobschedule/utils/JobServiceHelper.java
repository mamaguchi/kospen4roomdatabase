package com.example.intel.kospenmove02.jobschedule.utils;
...
public class JobServiceHelper {
    ...
    //Constructor
    public JobServiceHelper(Context context) {
    ...
    public boolean checkIsOutRestReqSyncRequired() {
        ...
        return (kospenuserDirtyCount!=0 || screeningNotEmptyCount!=0);
    }
    ...
    private void getInsideLocalityKospenuserReq() {
        ...
        MySingleton.getInstance(mContext).addToRequestQueue(getInsideLocalityRequest);
    ...
    private void getOutsideLocalityKospenuserReq() {
        ...
        MySingleton.getInstance(mContext).addToRequestQueue(getOutsideLocalityRequest);
